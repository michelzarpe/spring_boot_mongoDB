...
public class Instantiation implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Post p1 = new Post(null, sdf.parse("21/03/2018"),"Partiu Viagem", "vou viajar para joaçaba",maria);
		Post p2 = new Post(null, sdf.parse("23/03/2018"),"Bom dia", "Acordei de Boa hoje",maria);
